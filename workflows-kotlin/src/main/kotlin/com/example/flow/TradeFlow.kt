...
object TradeFlow {
    ...
    val transactionUnits: Int) : FlowLogic<SignedTransaction>() {
        ...
        override fun call(): SignedTransaction {
            ...
            val tradeState = TradeState(sellValue,sellCurrency,buyValue,buyCurrency,serviceHub.myInfo.legalIdentities.first(), counterParty,tradeStatus,regulator,userId,assetCode,orderType,transactionAmount,transactionFees,transactionUnits)
